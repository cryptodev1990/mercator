...
- lookbacks and method means that different periods of time are included
- lookbacks are highly correlated
...
- Could be extended to take MMM existing estimates of 
- TODO: look more at Robyn MMM models and how they interact with geo-spatial experiments.
- TODO: look at missing data handling. Could we match on factors instead of Y's? 

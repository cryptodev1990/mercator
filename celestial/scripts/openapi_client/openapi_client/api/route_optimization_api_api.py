...
class RouteOptimizationAPIApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.async_vrp_endpoint = _Endpoint(
            settings={
                'response_type': (JobId,),
                'auth': [
                    'api_key'
                ],
                'endpoint_path': '/vrp/optimize',
                'operation_id': 'async_vrp',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_solution_endpoint = _Endpoint(
            settings={
                'response_type': (Response,),
                'auth': [
                    'api_key'
                ],
                'endpoint_path': '/vrp/solution/{jobId}',
                'operation_id': 'get_solution',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.solve_vrp_endpoint = _Endpoint(
            settings={
                'response_type': (Response,),
                'auth': [
                    'api_key'
    ...
    def async_vrp(
        ...
        **kwargs
        ...
        """POST route optimization problem (batch mode)  # noqa: E501
        ...
        >>> thread = api.async_vrp(request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['request'] = \
            request
        return self.async_vrp_endpoint.call_with_http_info(**kwargs)
    ...
    def get_solution(
        ...
        **kwargs
        ...
        """GET the solution (batch mode)  # noqa: E501

         Take the job id and fetch the solution for the vehicle routing problem from this URL:  ``` https://graphhopper.com/api/1/vrp/solution/<job_id>?key=<your_key> ```  You get the job id by sending a vehicle routing problem to the [batch mode URL](#operation/asyncVRP).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['job_id'] = \
            job_id
        return self.get_solution_endpoint.call_with_http_info(**kwargs)
    ...
    def solve_vrp(
        ...
        **kwargs
        ...
        """POST route optimization problem  # noqa: E501

         To get started with the Route Optimization API, please read the [introduction](#tag/Route-Optimization-API).  To solve a new vehicle routing problem, make a HTTP POST to this URL  ``` https://graphhopper.com/api/1/vrp?key=<your_key> ```  It returns the solution to this problem in the JSON response.  Please note that this URL is very well suited to solve minor problems. Larger vehicle routing problems, which take longer than 10 seconds to solve, cannot be solved. To solve them, please use the [batch mode URL](#operation/asyncVRP) instead.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.solve_vrp(request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['request'] = \
            request
        return self.solve_vrp_endpoint.call_with_http_info(**kwargs)

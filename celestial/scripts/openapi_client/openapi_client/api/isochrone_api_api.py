...
class IsochroneAPIApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_isochrone_endpoint = _Endpoint(
            settings={
                'response_type': (IsochroneResponse,),
                'auth': [
                    'api_key'
                ],
                'endpoint_path': '/isochrone',
                'operation_id': 'get_isochrone',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_isochrone(
        ...
        **kwargs
        ...
        kwargs['point'] = \
            point
        return self.get_isochrone_endpoint.call_with_http_info(**kwargs)

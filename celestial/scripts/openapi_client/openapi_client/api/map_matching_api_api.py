...
class MapMatchingAPIApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.post_gpx_endpoint = _Endpoint(
            settings={
    ...
    def post_gpx(
        ...
        **kwargs
        ...
        """Map-match a GPX file  # noqa: E501
        ...
        >>> thread = api.post_gpx(async_req=True)
        >>> result = thread.get()
        ...
        return self.post_gpx_endpoint.call_with_http_info(**kwargs)

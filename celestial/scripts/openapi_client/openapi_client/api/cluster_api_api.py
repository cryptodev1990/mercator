...
class ClusterAPIApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.async_clustering_problem_endpoint = _Endpoint(
            settings={
                'response_type': (JobId,),
                'auth': [
                    'api_key'
                ],
                'endpoint_path': '/cluster/calculate',
                'operation_id': 'async_clustering_problem',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_cluster_solution_endpoint = _Endpoint(
            settings={
                'response_type': (ClusterResponse,),
                'auth': [
                    'api_key'
                ],
                'endpoint_path': '/cluster/solution/{jobId}',
                'operation_id': 'get_cluster_solution',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.solve_clustering_problem_endpoint = _Endpoint(
            settings={
                'response_type': (ClusterResponse,),
                'auth': [
                    'api_key'
                ...
                'operation_id': 'solve_clustering_problem',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def async_clustering_problem(
        self,
        cluster_request,
        **kwargs
    ):
        """Batch Cluster Endpoint  # noqa: E501

         Prefer the [synchronous endpoint](#operation/solveClusteringProblem) and use this Batch Cluster endpoint for long running problems only. The work flow is asynchronous:  - send a POST request towards `https://graphhopper.com/api/1/cluster/calculate?key=<your_key>` and fetch the job_id. - poll the solution every 500ms until it gives `status=finished`. Do this with a GET request   towards `https://graphhopper.com/api/1/cluster/solution/<job_id>?key=<your_key>`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.async_clustering_problem(cluster_request, async_req=True)
        >>> result = thread.get()

        Args:
            cluster_request (ClusterRequest): Request object that contains the problem to be solved
        ...
        kwargs['cluster_request'] = \
            cluster_request
        return self.async_clustering_problem_endpoint.call_with_http_info(**kwargs)

    def get_cluster_solution(
        self,
        job_id,
        **kwargs
    ):
        """GET Batch Solution Endpoint  # noqa: E501

        This endpoint returns the solution of the clustering problems submitted to the [Batch Cluster endpoint](#operation/asyncClusteringProblem). You can fetch it with the job_id, you have been sent.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_cluster_solution(job_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['job_id'] = \
            job_id
        return self.get_cluster_solution_endpoint.call_with_http_info(**kwargs)
    ...
    def solve_clustering_problem(
        ...
        **kwargs
        ...
        kwargs['cluster_request'] = \
            cluster_request
        return self.solve_clustering_problem_endpoint.call_with_http_info(**kwargs)

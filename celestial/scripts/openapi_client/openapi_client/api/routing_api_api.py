...
class RoutingAPIApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_route_endpoint = _Endpoint(
            settings={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'calc_points': 'query',
                    'debug': 'query',
                    'points_encoded': 'query',
                    'ch_disable': 'query',
                    'heading': 'query',
                    'heading_penalty': 'query',
                    'pass_through': 'query',
                    'algorithm': 'query',
                    'round_trip_distance': 'query',
                    'round_trip_seed': 'query',
                    'alternative_route_max_paths': 'query',
                    'alternative_route_max_weight_factor': 'query',
                    'alternative_route_max_share_factor': 'query',
                },
        ...
        self.post_route_endpoint = _Endpoint(
            settings={
                'response_type': (RouteResponse,),
                'auth': [
                    'api_key'
        ...
        self.route_info_get_endpoint = _Endpoint(
            settings={
                'response_type': (InfoResponse,),
                'auth': [
                    'api_key'
                ],
                'endpoint_path': '/route/info',
                'operation_id': 'route_info_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_route(
        ...
        **kwargs
        ...
        """GET Route Endpoint  # noqa: E501

        The GET request is the most simple one: just specify the parameter in the URL and you are done. Can be tried directly in every browser.   # noqa: E501
        ...
        kwargs['point'] = \
            point
        return self.get_route_endpoint.call_with_http_info(**kwargs)

    def post_route(
        self,
        **kwargs
    ):
        """POST Route Endpoint  # noqa: E501
        ...
        >>> thread = api.post_route(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            route_request (RouteRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.post_route_endpoint.call_with_http_info(**kwargs)
    ...
    def route_info_get(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.route_info_get_endpoint.call_with_http_info(**kwargs)

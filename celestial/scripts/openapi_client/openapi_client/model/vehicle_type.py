...
class VehicleType(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'speed_factor': (float,),  # noqa: E501
            'service_time_factor': (float,),  # noqa: E501
            'cost_per_meter': (float,),  # noqa: E501
            'cost_per_second': (float,),  # noqa: E501
            'cost_per_activation': (float,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'speed_factor': 'speed_factor',  # noqa: E501
        'service_time_factor': 'service_time_factor',  # noqa: E501
        'cost_per_meter': 'cost_per_meter',  # noqa: E501
        'cost_per_second': 'cost_per_second',  # noqa: E501
        'cost_per_activation': 'cost_per_activation',  # noqa: E501
    ...
    def _from_openapi_data(cls, type_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            speed_factor (float): Specifies a speed factor for this vehicle type. If the vehicle that uses this type needs to be only half as fast as what is actually calculated with our routing engine then set the speed factor to 0.5.. [optional] if omitted the server will use the default value of 1  # noqa: E501
            ...
            cost_per_meter (float): **_BETA feature_**! Cost parameter per distance unit, here meter is used. [optional]  # noqa: E501
            cost_per_second (float): **_BETA feature_**! Cost parameter per time unit, here second is used. [optional]  # noqa: E501
            cost_per_activation (float): **_BETA feature_**! Cost parameter vehicle activation, i.e. fixed costs per vehicle. [optional]  # noqa: E501

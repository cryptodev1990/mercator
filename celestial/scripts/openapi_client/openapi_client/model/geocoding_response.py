...
def lazy_import():
    ...
    globals()['GeocodingLocation'] = GeocodingLocation
...
class GeocodingResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'hits': ([GeocodingLocation],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            hits ([GeocodingLocation]): [optional]  # noqa: E501
            took (float): in ms. [optional]  # noqa: E501
        """

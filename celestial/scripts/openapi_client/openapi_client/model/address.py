...
class Address(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'lat': (float,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'street_hint': (str,),  # noqa: E501
            'curbside': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'lat': 'lat',  # noqa: E501
        'name': 'name',  # noqa: E501
        'street_hint': 'street_hint',  # noqa: E501
        'curbside': 'curbside',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, location_id, lon, lat, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): Name of location.. [optional]  # noqa: E501
            street_hint (str): Optional parameter. Specifies a hint for each address to better snap the coordinates (lon,lat) to road network. E.g. if there is an address or house with two or more neighboring streets you can control for which street the closest location is looked up.. [optional]  # noqa: E501
            curbside (str): Optional parameter. Specifies on which side a point should be relative to the driver when she leaves/arrives at a start/target/via point. Only supported for motor vehicles and OpenStreetMap.. [optional] if omitted the server will use the default value of "any"  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, location_id, lon, lat, *args, **kwargs):  # noqa: E501
        """Address - a model defined in OpenAPI

...
class RouteResponsePathInstructionsInner(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sign': (int,),  # noqa: E501
            'exit_number': (int,),  # noqa: E501
            'turn_angle': (float,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'sign': 'sign',  # noqa: E501
        'exit_number': 'exit_number',  # noqa: E501
        'turn_angle': 'turn_angle',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            text (str): A description what the user has to do in order to follow the route. The language depends on the locale parameter. . [optional]  # noqa: E501
            street_name (str): The name of the street to turn onto in order to follow the route. . [optional]  # noqa: E501
            distance (float): The distance for this instruction, in meters. . [optional]  # noqa: E501
            time (int): The duration for this instruction, in milliseconds. . [optional]  # noqa: E501
            interval ([int]): Two indices into `points`, referring to the beginning and the end of the segment of the route this instruction refers to. . [optional]  # noqa: E501
            ...
            exit_number (int): Only available for roundabout instructions (sign is 6). The count of exits at which the route leaves the roundabout. . [optional]  # noqa: E501
            turn_angle (float): Only available for roundabout instructions (sign is 6). The radian of the route within the roundabout `0 < r < 2*PI` for clockwise and `-2*PI < r < 0` for counterclockwise turns. . [optional]  # noqa: E501
        """

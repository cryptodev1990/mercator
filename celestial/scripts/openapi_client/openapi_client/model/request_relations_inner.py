...
def lazy_import():
    ...
    globals()['GroupRelation'] = GroupRelation
    globals()['JobRelation'] = JobRelation


class RequestRelationsInner(ModelComposed):

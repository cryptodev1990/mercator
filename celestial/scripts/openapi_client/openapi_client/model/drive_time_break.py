...
class DriveTimeBreak(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, duration, max_driving_time, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, duration, max_driving_time, *args, **kwargs):  # noqa: E501
        """DriveTimeBreak - a model defined in OpenAPI

...
class MatrixRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'from_points': ([[float]],),  # noqa: E501
            'to_points': ([[float]],),  # noqa: E501
            'from_point_hints': ([str],),  # noqa: E501
            'to_point_hints': ([str],),  # noqa: E501
            'snap_preventions': ([str],),  # noqa: E501
            'from_curbsides': ([str],),  # noqa: E501
            'to_curbsides': ([str],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'from_points': 'from_points',  # noqa: E501
        'to_points': 'to_points',  # noqa: E501
        'from_point_hints': 'from_point_hints',  # noqa: E501
        'to_point_hints': 'to_point_hints',  # noqa: E501
        'snap_preventions': 'snap_preventions',  # noqa: E501
        'from_curbsides': 'from_curbsides',  # noqa: E501
        'to_curbsides': 'to_curbsides',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            from_points ([[float]]): The starting points for the routes in an array of `[longitude,latitude]`. For instance, if you want to calculate three routes from point A such as A->1, A->2, A->3 then you have one `from_point` parameter and three `to_point` parameters.. [optional]  # noqa: E501
            to_points ([[float]]): The destination points for the routes in an array of `[longitude,latitude]`.. [optional]  # noqa: E501
            from_point_hints ([str]): See `point_hints`of symmetrical matrix. [optional]  # noqa: E501
            to_point_hints ([str]): See `point_hints`of symmetrical matrix. [optional]  # noqa: E501
            snap_preventions ([str]): See `snap_preventions` of symmetrical matrix. [optional]  # noqa: E501
            from_curbsides ([str]): See `curbsides`of symmetrical matrix. [optional]  # noqa: E501
            to_curbsides ([str]): See `curbsides`of symmetrical matrix. [optional]  # noqa: E501
            out_arrays ([str]): Specifies which matrices should be included in the response. Specify one or more of the following options `weights`, `times`, `distances`. The units of the entries of `distances` are meters, of `times` are seconds and of `weights` is arbitrary and it can differ for different vehicles or versions of this API.. [optional]  # noqa: E501

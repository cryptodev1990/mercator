...
def lazy_import():
    ...
    globals()['IsochroneResponsePolygon'] = IsochroneResponsePolygon


class IsochroneResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'polygons': ([IsochroneResponsePolygon],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            polygons ([IsochroneResponsePolygon]): The list of polygons in GeoJson format. It can be used e.g. in the Leaflet framework:  ``` L.geoJson(json.polygons).addTo(map) ```  The number of polygon is identical to the specified buckets in the query. Every polygon contains the bucket number in the properties section of the GeoJson. . [optional]  # noqa: E501
            copyrights ([str]): [optional]  # noqa: E501
        """

...
def lazy_import():
    ...
    globals()['MatrixResponseHintsInner'] = MatrixResponseHintsInner
    globals()['ResponseInfo'] = ResponseInfo


class MatrixResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'distances': ([[float]],),  # noqa: E501
            'times': ([[float]],),  # noqa: E501
            'weights': ([[float]],),  # noqa: E501
            'info': (ResponseInfo,),  # noqa: E501
            'hints': ([MatrixResponseHintsInner],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            distances ([[float]]): The distance matrix for the specified points in the same order as the time matrix. The distances are in meters. If `fail_fast=false` the matrix will contain `null` for connections that could not be found.. [optional]  # noqa: E501
            times ([[float]]): The time matrix for the specified points in the order [[from1->to1, from1->to2, ...], [from2->to1, from2->to2, ...], ...]. The times are in seconds. If `fail_fast=false` the matrix will contain `null` for connections that could not be found.. [optional]  # noqa: E501
            weights ([[float]]): The weight matrix for the specified points in the same order as the time matrix. The weights for different vehicle profiles can have a different unit but the weights array is perfectly suited as input for Vehicle Routing Problems as it is currently faster to calculate. If `fail_fast=false` the matrix will contain `null` for connections that could not be found.. [optional]  # noqa: E501
            info (ResponseInfo): [optional]  # noqa: E501
            hints ([MatrixResponseHintsInner]): Optional. Additional response data.. [optional]  # noqa: E501
        """

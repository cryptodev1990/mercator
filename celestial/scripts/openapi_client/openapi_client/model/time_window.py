...
class TimeWindow(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            earliest (int): Specifies the opening time of the time window in seconds, i.e. the earliest time the service can start.. [optional] if omitted the server will use the default value of 0  # noqa: E501
            latest (int): Specifies the closing time of the time window in seconds, i.e. the latest time the service can start.. [optional]  # noqa: E501
        """

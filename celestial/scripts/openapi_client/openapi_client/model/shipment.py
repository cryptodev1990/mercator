...
class Shipment(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'pickup': (Stop,),  # noqa: E501
            'delivery': (Stop,),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, pickup, delivery, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): Meaningful name for shipment, e.g. \"pickup and deliver pizza to Peter\".. [optional]  # noqa: E501
            ...
            required_skills ([str]): Specifies an array of required skills, i.e. array of string (not case sensitive). For example, if this shipment needs to be conducted by a technician having a `drilling_machine` and a `screw_driver` then specify the array as follows: `[\"drilling_machine\",\"screw_driver\"]`. This means that the service can only be done by a vehicle (technician) that has the skills `drilling_machine` AND `screw_driver` in its skill array. Otherwise it remains unassigned.. [optional]  # noqa: E501
            allowed_vehicles ([str]): Specifies an array of allowed vehicles, i.e. array of vehicle ids. For example, if this shipment can only be conducted EITHER by \"technician_peter\" OR \"technician_stefan\" specify this as follows: [\"technician_peter\",\"technician_stefan\"].. [optional]  # noqa: E501
            disallowed_vehicles ([str]): Specifies an array of disallowed vehicles, i.e. array of vehicle ids.. [optional]  # noqa: E501
            max_time_in_vehicle (int): Specifies the maximum time in seconds a shipment can stay in the vehicle.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, pickup, delivery, *args, **kwargs):  # noqa: E501
        """Shipment - a model defined in OpenAPI

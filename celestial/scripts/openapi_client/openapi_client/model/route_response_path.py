...
def lazy_import():
    ...
    globals()['RouteResponsePathInstructionsInner'] = RouteResponsePathInstructionsInner
    globals()['RouteResponsePathPoints'] = RouteResponsePathPoints
    globals()['RouteResponsePathSnappedWaypoints'] = RouteResponsePathSnappedWaypoints


class RouteResponsePath(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'time': (int,),  # noqa: E501
            'ascend': (float,),  # noqa: E501
            'descend': (float,),  # noqa: E501
            'points': (RouteResponsePathPoints,),  # noqa: E501
            'snapped_waypoints': (RouteResponsePathSnappedWaypoints,),  # noqa: E501
            'points_encoded': (bool,),  # noqa: E501
            'bbox': ([float],),  # noqa: E501
            'instructions': ([RouteResponsePathInstructionsInner],),  # noqa: E501
            'details': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'points_order': ([int],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'time': 'time',  # noqa: E501
        'ascend': 'ascend',  # noqa: E501
        'descend': 'descend',  # noqa: E501
        'points': 'points',  # noqa: E501
        'snapped_waypoints': 'snapped_waypoints',  # noqa: E501
        'points_encoded': 'points_encoded',  # noqa: E501
        'bbox': 'bbox',  # noqa: E501
        'instructions': 'instructions',  # noqa: E501
        'details': 'details',  # noqa: E501
        'points_order': 'points_order',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            distance (float): The total distance, in meters. To get this information for one 'leg' please read [this blog post](https://www.graphhopper.com/blog/2019/11/28/routing-api-using-path-details/). . [optional]  # noqa: E501
            time (int): The total travel time, in milliseconds. To get this information for one 'leg' please read [this blog post](https://www.graphhopper.com/blog/2019/11/28/routing-api-using-path-details/). . [optional]  # noqa: E501
            ascend (float): The total ascent, in meters. . [optional]  # noqa: E501
            descend (float): The total descent, in meters. . [optional]  # noqa: E501
            points (RouteResponsePathPoints): [optional]  # noqa: E501
            snapped_waypoints (RouteResponsePathSnappedWaypoints): [optional]  # noqa: E501
            points_encoded (bool): Whether the `points` and `snapped_waypoints` fields are polyline-encoded strings rather than JSON arrays of coordinates. See the field description for more information on the two formats. . [optional]  # noqa: E501
            bbox ([float]): The bounding box of the route geometry. Format: `[minLon, minLat, maxLon, maxLat]`. . [optional]  # noqa: E501
            instructions ([RouteResponsePathInstructionsInner]): The instructions for this route. This feature is under active development, and our instructions can sometimes be misleading, so be mindful when using them for navigation. . [optional]  # noqa: E501
            details ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Details, as requested with the `details` parameter. Consider the value `{\"street_name\": [[0,2,\"Frankfurter Straße\"],[2,6,\"Zollweg\"]]}`. In this example, the route uses two streets: The first, Frankfurter Straße, is used between `points[0]` and `points[2]`, and the second, Zollweg, between `points[2]` and `points[6]`. See [here](https://discuss.graphhopper.com/t/2539) for discussion. . [optional]  # noqa: E501
            points_order ([int]): An array of indices (zero-based), specifiying the order in which the input points are visited. Only present if the `optimize` parameter was used. . [optional]  # noqa: E501
        """

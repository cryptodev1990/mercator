...
def lazy_import():
    ...
    globals()['VehicleBreak'] = VehicleBreak


class Vehicle(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'vehicle_id': (str,),  # noqa: E501
            'type_id': (str,),  # noqa: E501
            'start_address': (Address,),  # noqa: E501
            'end_address': (Address,),  # noqa: E501
            '_break': (VehicleBreak,),  # noqa: E501
            'return_to_depot': (bool,),  # noqa: E501
            'earliest_start': (int,),  # noqa: E501
            'latest_end': (int,),  # noqa: E501
            'skills': ([str],),  # noqa: E501
            'max_distance': (int,),  # noqa: E501
            'max_driving_time': (int,),  # noqa: E501
            'max_jobs': (int,),  # noqa: E501
            'min_jobs': (int,),  # noqa: E501
            'max_activities': (int,),  # noqa: E501
            'move_to_end_address': (bool,),  # noqa: E501
        }
    ...
    attribute_map = {
        'vehicle_id': 'vehicle_id',  # noqa: E501
        'type_id': 'type_id',  # noqa: E501
        'start_address': 'start_address',  # noqa: E501
        'end_address': 'end_address',  # noqa: E501
        '_break': 'break',  # noqa: E501
        'return_to_depot': 'return_to_depot',  # noqa: E501
        'earliest_start': 'earliest_start',  # noqa: E501
        'latest_end': 'latest_end',  # noqa: E501
        'skills': 'skills',  # noqa: E501
        'max_distance': 'max_distance',  # noqa: E501
        'max_driving_time': 'max_driving_time',  # noqa: E501
        'max_jobs': 'max_jobs',  # noqa: E501
        'min_jobs': 'min_jobs',  # noqa: E501
        'max_activities': 'max_activities',  # noqa: E501
        'move_to_end_address': 'move_to_end_address',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vehicle_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type_id (str): The type ID assigns a vehicle type to this vehicle. You can specify types in the array of vehicle types. If you omit the type ID, the default type is used. The default type is a `car` with a capacity of 0.. [optional] if omitted the server will use the default value of "default-type"  # noqa: E501
            start_address (Address): [optional]  # noqa: E501
            end_address (Address): [optional]  # noqa: E501
            _break (VehicleBreak): [optional]  # noqa: E501
            ...
            earliest_start (int): Earliest start of vehicle in seconds. It is recommended to use the unix timestamp.. [optional] if omitted the server will use the default value of 0  # noqa: E501
            latest_end (int): Latest end of vehicle in seconds, i.e. the time the vehicle needs to be at its end location at latest.. [optional]  # noqa: E501
            skills ([str]): Array of skills, i.e. array of string (not case sensitive).. [optional]  # noqa: E501
            max_distance (int): Specifies the maximum distance (in meters) a vehicle can go.. [optional]  # noqa: E501
            max_driving_time (int): Specifies the maximum drive time (in seconds) a vehicle/driver can go, i.e. the maximum time on the road (service and waiting times are not included here). [optional]  # noqa: E501
            max_jobs (int): Specifies the maximum number of jobs a vehicle can load.. [optional]  # noqa: E501
            min_jobs (int): Specifies the minimum number of jobs a vehicle should load. This is a soft constraint, i.e. if it is not possible to fulfill “min_jobs”, we will still try to get as close as possible to this constraint.. [optional]  # noqa: E501
            max_activities (int): Specifies the maximum number of activities a vehicle can conduct.. [optional]  # noqa: E501
            move_to_end_address (bool): Indicates whether a vehicle should be moved even though it has not been assigned any jobs.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, vehicle_id, *args, **kwargs):  # noqa: E501
        """Vehicle - a model defined in OpenAPI

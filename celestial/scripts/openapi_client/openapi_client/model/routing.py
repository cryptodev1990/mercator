...
class Routing(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'consider_traffic': (bool,),  # noqa: E501
            'network_data_provider': (str,),  # noqa: E501
            'curbside_strictness': (str,),  # noqa: E501
            'fail_fast': (bool,),  # noqa: E501
            'return_snapped_waypoints': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'consider_traffic': 'consider_traffic',  # noqa: E501
        'network_data_provider': 'network_data_provider',  # noqa: E501
        'curbside_strictness': 'curbside_strictness',  # noqa: E501
        'fail_fast': 'fail_fast',  # noqa: E501
        'return_snapped_waypoints': 'return_snapped_waypoints',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            calc_points (bool): It lets you specify whether the API should provide you with route geometries for vehicle routes or not. Thus, you do not need to do extra routing to get the polyline for each route.. [optional] if omitted the server will use the default value of False  # noqa: E501
            consider_traffic (bool): indicates whether historical traffic information should be considered. [optional] if omitted the server will use the default value of False  # noqa: E501
            network_data_provider (str): specifies the data provider, read more about it [here](#section/Map-Data-and-Routing-Profiles).. [optional] if omitted the server will use the default value of "openstreetmap"  # noqa: E501
            ...
            fail_fast (bool): indicates whether matrix calculation should fail fast when points cannot be connected. [optional] if omitted the server will use the default value of True  # noqa: E501
            return_snapped_waypoints (bool): Indicates whether a solution includes snapped waypoints. In contrary to the address coordinate a snapped waypoint is the access point to the (road) network.. [optional] if omitted the server will use the default value of False  # noqa: E501
            snap_preventions ([str]): Prevents snapping locations to road links of specified road types, e.g. to motorway. Please note that this feature does not e.g. avoid motorways for the route - it only avoids it for the \"location snap\".. [optional]  # noqa: E501
        """

...
class TimeWindowBreak(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, earliest, latest, duration, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, earliest, latest, duration, *args, **kwargs):  # noqa: E501
        """TimeWindowBreak - a model defined in OpenAPI

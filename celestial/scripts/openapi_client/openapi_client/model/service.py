...
class Service(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'preparation_time': (int,),  # noqa: E501
            'time_windows': ([TimeWindow],),  # noqa: E501
            'size': ([int],),  # noqa: E501
            'required_skills': ([str],),  # noqa: E501
            'allowed_vehicles': ([str],),  # noqa: E501
            'disallowed_vehicles': ([str],),  # noqa: E501
            'max_time_in_vehicle': (int,),  # noqa: E501
            'group': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'preparation_time': 'preparation_time',  # noqa: E501
        'time_windows': 'time_windows',  # noqa: E501
        'size': 'size',  # noqa: E501
        'required_skills': 'required_skills',  # noqa: E501
        'allowed_vehicles': 'allowed_vehicles',  # noqa: E501
        'disallowed_vehicles': 'disallowed_vehicles',  # noqa: E501
        'max_time_in_vehicle': 'max_time_in_vehicle',  # noqa: E501
    ...
    def _from_openapi_data(cls, id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): Specifies type of service. This makes a difference if items are loaded or unloaded, i.e. if one of the size dimensions > 0. If it is specified as `service` or `pickup`, items are loaded and will stay in the vehicle for the rest of the route (and thus consumes capacity for the rest of the route). If it is a `delivery`, items are implicitly loaded at the beginning of the route and will stay in the route until delivery (and thus releases capacity for the rest of the route).. [optional] if omitted the server will use the default value of "service"  # noqa: E501
            priority (int): Specifies the priority. Can be 1 = high priority to 10 = low priority. Often there are more services/shipments than the available vehicle fleet can handle. Then you can set priorities to differentiate high priority tasks from those that could be left unassigned. I.e. the lower the priority the earlier these tasks are omitted in the solution.. [optional] if omitted the server will use the default value of 2  # noqa: E501
            name (str): Meaningful name for service, e.g. `\"deliver pizza\"`.. [optional]  # noqa: E501
            address (Address): [optional]  # noqa: E501
            duration (int): Specifies the duration of the service in seconds, i.e. how long it takes at the customer site.. [optional] if omitted the server will use the default value of 0  # noqa: E501
            preparation_time (int): Specifies the preparation time in seconds. It can be used to model parking lot search time since if you have 3 identical locations in a row, it only falls due once.. [optional] if omitted the server will use the default value of 0  # noqa: E501
            time_windows ([TimeWindow]): Specifies an array of time window objects (see time_window object below). Specify the time either with the recommended Unix time stamp (the number of seconds since 1970-01-01) or you can also count the seconds relative to Monday morning 00:00 and define the whole week in seconds. For example, Monday 9am is then represented by 9hour * 3600sec/hour = 32400. In turn, Wednesday 1pm corresponds to 2day * 24hour/day * 3600sec/hour + 1day * 13hour/day * 3600sec/hour = 219600. See this tutorial for more information.. [optional]  # noqa: E501
            size ([int]): Size can have multiple dimensions and should be in line with the capacity dimension array of the vehicle type. For example, if the item that needs to be delivered has two size dimension, volume and weight, then specify it as follow [ 20, 5 ] assuming a volume of 20 and a weight of 5.. [optional] if omitted the server will use the default value of [0]  # noqa: E501
            required_skills ([str]): Specifies an array of required skills, i.e. array of string (not case sensitive). For example, if this service needs to be conducted by a technician having a `drilling_machine` and a `screw_driver` then specify the array as follows: `[\"drilling_machine\",\"screw_driver\"]`. This means that the service can only be done by a vehicle (technician) that has the skills `drilling_machine` AND `screw_driver` in its skill array. Otherwise it remains unassigned.. [optional]  # noqa: E501
            allowed_vehicles ([str]): Specifies an array of allowed vehicles, i.e. array of vehicle ids. For example, if this service can only be conducted EITHER by `technician_peter` OR `technician_stefan` specify this as follows: `[\"technician_peter\",\"technician_stefan\"]`.. [optional]  # noqa: E501
            disallowed_vehicles ([str]): Specifies an array of disallowed vehicles, i.e. array of vehicle ids.. [optional]  # noqa: E501
            max_time_in_vehicle (int): Specifies the maximum time in seconds a delivery can stay in the vehicle. Currently, it only works with services of \"type\":\"delivery\".. [optional]  # noqa: E501
            group (str): Group this service belongs to. See the group relation and [this post](https://discuss.graphhopper.com/t/4040) on how to utilize this.. [optional]  # noqa: E501
        """

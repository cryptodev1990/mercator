...
class InfoResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'bbox': (str,),  # noqa: E501
            'features': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            version (str): The version of the GraphHopper server that provided this response. This is not related to the API version. . [optional]  # noqa: E501
            bbox (str): The bounding box of the geographical area covered by this GraphHopper instance. Format: `\"minLon,minLat,maxLon,maxLat\" . [optional]  # noqa: E501
            features ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The supported features, such as elevation, per vehicle profile. . [optional]  # noqa: E501
        """

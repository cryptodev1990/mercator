...
def lazy_import():
    ...
    globals()['DriveTimeBreak'] = DriveTimeBreak
    globals()['TimeWindowBreak'] = TimeWindowBreak


class VehicleBreak(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'initial_driving_time': (int,),  # noqa: E501
            'possible_split': ([int],),  # noqa: E501
            'earliest': (int,),  # noqa: E501
            'latest': (int,),  # noqa: E501
    ...
    attribute_map = {
        'initial_driving_time': 'initial_driving_time',  # noqa: E501
        'possible_split': 'possible_split',  # noqa: E501
        'earliest': 'earliest',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            initial_driving_time (int): Specifies the initial (current) driving time of a driver to allow dynamic adaptations in seconds.. [optional]  # noqa: E501
            possible_split ([int]): Array specifying how a break duration (in seconds) can be split into several smaller breaks. [optional]  # noqa: E501
            earliest (int): Specifies the earliest start time of the break in seconds.. [optional]  # noqa: E501
            latest (int): Specifies the latest start time of break in seconds.. [optional]  # noqa: E501
            duration (int): Specifies the duration of the break in seconds.. [optional]  # noqa: E501
            max_driving_time (int): Specifies the max driving time (in a row) without break in seconds.. [optional]  # noqa: E501
        """

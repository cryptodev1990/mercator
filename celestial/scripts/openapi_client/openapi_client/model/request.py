...
def lazy_import():
    ...
    globals()['CostMatrix'] = CostMatrix
    globals()['Objective'] = Objective
    globals()['RequestRelationsInner'] = RequestRelationsInner
    globals()['Service'] = Service
    globals()['Shipment'] = Shipment
    globals()['Vehicle'] = Vehicle
    globals()['VehicleType'] = VehicleType
...
class Request(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'vehicles': ([Vehicle],),  # noqa: E501
            'vehicle_types': ([VehicleType],),  # noqa: E501
            'services': ([Service],),  # noqa: E501
            'shipments': ([Shipment],),  # noqa: E501
            'relations': ([RequestRelationsInner],),  # noqa: E501
            'algorithm': (Algorithm,),  # noqa: E501
            'objectives': ([Objective],),  # noqa: E501
            'cost_matrices': ([CostMatrix],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            vehicles ([Vehicle]): Specifies the available vehicles.. [optional]  # noqa: E501
            vehicle_types ([VehicleType]): Specifies the available vehicle types. These types can be assigned to vehicles.. [optional]  # noqa: E501
            services ([Service]): Specifies the orders of the type \"service\". These are, for example, pick-ups, deliveries or other stops that are to be approached by the specified vehicles. Each of these orders contains only one location.. [optional]  # noqa: E501
            shipments ([Shipment]): Specifies the available shipments. Each shipment contains a pickup and a delivery stop, which must be processed one after the other.. [optional]  # noqa: E501
            relations ([RequestRelationsInner]): Defines additional relationships between orders.. [optional]  # noqa: E501
            algorithm (Algorithm): [optional]  # noqa: E501
            objectives ([Objective]): Specifies an objective function. The vehicle routing problem is solved in such a way that this objective function is minimized.. [optional]  # noqa: E501
            cost_matrices ([CostMatrix]): Specifies your own tranport time and distance matrices.. [optional]  # noqa: E501
            configuration (Configuration): [optional]  # noqa: E501
        """

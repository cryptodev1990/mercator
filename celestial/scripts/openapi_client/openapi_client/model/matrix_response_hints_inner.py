...
class MatrixResponseHintsInner(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'invalid_from_points': ([float],),  # noqa: E501
            'invalid_to_points': ([float],),  # noqa: E501
            'point_pairs': ([[float]],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'invalid_from_points': 'invalid_from_points',  # noqa: E501
        'invalid_to_points': 'invalid_to_points',  # noqa: E501
        'point_pairs': 'point_pairs',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            message (str): Short description of this hint. [optional]  # noqa: E501
            details (str): Details of this hint. [optional]  # noqa: E501
            invalid_from_points ([float]): Optional. An array of from_point indices of points that could not be found. Will only be added if `fail_fast=false` and some `from_point`s were not found.`. [optional]  # noqa: E501
            invalid_to_points ([float]): Optional. An array of to_point indices of points that could not be found. Will only be added if `fail_fast=false` and some `to_point`s were not found.`. [optional]  # noqa: E501
            point_pairs ([[float]]): Optional. An array of two-element arrays representing the from/to_point indices of points for which no connection could be found. Will only be added if `fail_fast=false` and some connections were not found.. [optional]  # noqa: E501
        """

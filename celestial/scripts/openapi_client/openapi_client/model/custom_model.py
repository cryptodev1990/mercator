...
class CustomModel(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'speed': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
            'priority': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
            'distance_influence': (float,),  # noqa: E501
            'areas': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'distance_influence': 'distance_influence',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CustomModel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            speed ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): See [speed customization](#section/Custom-Model/Customizing-speed). [optional]  # noqa: E501
            priority ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): See [priority customization](#section/Custom-Model/Customizing-priority). [optional]  # noqa: E501
            distance_influence (float): Use higher values to prefer shorter routes. See [here](#section/Custom-Model/Customizing-distance_influence) for more details.. [optional] if omitted the server will use the default value of 70  # noqa: E501
            areas ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Areas are given in a GeoJson format. Currently only one format is supported: one object with type Feature, a geometry with type Polygon and optional (but ignored) id and properties fields. See more details and an example [here](#section/Custom-Model/Define-areas). . [optional]  # noqa: E501
        """

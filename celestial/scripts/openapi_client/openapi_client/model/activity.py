...
def lazy_import():
    ...
    globals()['ResponseAddress'] = ResponseAddress
...
class Activity(ModelNormal):
    ...
    attribute_map = {
        ...
        'arr_time': 'arr_time',  # noqa: E501
        'end_time': 'end_time',  # noqa: E501
        'end_date_time': 'end_date_time',  # noqa: E501
        'arr_date_time': 'arr_date_time',  # noqa: E501
        ...
        'load_before': 'load_before',  # noqa: E501
        'load_after': 'load_after',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): type of activity. [optional]  # noqa: E501
            id (str): Id referring to the underlying service or shipment, i.e. the shipment or service this activity belongs to. [optional]  # noqa: E501
            location_id (str): Id that refers to address. [optional]  # noqa: E501
            address (ResponseAddress): [optional]  # noqa: E501
            arr_time (int): Arrival time at this activity in seconds. If type is `start`, this is not available (since it makes no sense to have `arr_time` at start). However, `end_time` is available and actually means \\\"departure time\\\" at start location. It is important to note that `arr_time` does not necessarily mean \\\"start of underlying activity\\\", it solely means arrival time at activity location. If this activity has no time windows and if there are no further preparation times, `arr_time` is equal to activity start time.. [optional]  # noqa: E501
            end_time (int): End time of and thus departure time at this activity. If type is `end`, this is not available (since it makes no sense to have an `end_time` at end) `end_time` at each activity is equal to the departure time at the activity location.. [optional]  # noqa: E501
            end_date_time (datetime): End date time with offset like this 1970-01-01T01:00+01:00. If you do not use time-dependent optimization, this is `null`.. [optional]  # noqa: E501
            arr_date_time (datetime): Arrival date time with offset like this 1970-01-01T01:00+01:00. If you do not use time-dependent optimization, this is `null`.. [optional]  # noqa: E501
            waiting_time (int): Waiting time at this activity in seconds. A waiting time can occur if the activity has at least one time window. If `arr_time` < `time_window.earliest` a waiting time of `time_window_earliest` - `arr_time` occurs.. [optional]  # noqa: E501
            preparation_time (int): preparation time at this activity in seconds. [optional]  # noqa: E501
            distance (int): cumulated distance from start to this activity in m. [optional]  # noqa: E501
            driving_time (int): cumulated driving time from start to this driver activity in seconds. [optional]  # noqa: E501
            load_before ([int]): Array with size/capacity dimensions before this activity. [optional]  # noqa: E501
            load_after ([int]): Array with size/capacity dimensions after this activity. [optional]  # noqa: E501
        """

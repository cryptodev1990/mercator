...
class RouteRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'elevation': (bool,),  # noqa: E501
            'details': ([str],),  # noqa: E501
            'optimize': (str,),  # noqa: E501
            'instructions': (bool,),  # noqa: E501
            'calc_points': (bool,),  # noqa: E501
            'debug': (bool,),  # noqa: E501
            'points_encoded': (bool,),  # noqa: E501
            'ch_disable': (bool,),  # noqa: E501
            'custom_model': (CustomModel,),  # noqa: E501
            'headings': ([int],),  # noqa: E501
            'heading_penalty': (int,),  # noqa: E501
            'pass_through': (bool,),  # noqa: E501
            'algorithm': (str,),  # noqa: E501
            'round_trip_distance': (int,),  # noqa: E501
            'round_trip_seed': (int,),  # noqa: E501
            'alternative_route_max_paths': (int,),  # noqa: E501
            'alternative_route_max_weight_factor': (float,),  # noqa: E501
            'alternative_route_max_share_factor': (float,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'calc_points': 'calc_points',  # noqa: E501
        'debug': 'debug',  # noqa: E501
        'points_encoded': 'points_encoded',  # noqa: E501
        'ch_disable': 'ch.disable',  # noqa: E501
        'custom_model': 'custom_model',  # noqa: E501
        'headings': 'headings',  # noqa: E501
        'heading_penalty': 'heading_penalty',  # noqa: E501
        'pass_through': 'pass_through',  # noqa: E501
        'algorithm': 'algorithm',  # noqa: E501
        'round_trip_distance': 'round_trip.distance',  # noqa: E501
        'round_trip_seed': 'round_trip.seed',  # noqa: E501
        'alternative_route_max_paths': 'alternative_route.max_paths',  # noqa: E501
        'alternative_route_max_weight_factor': 'alternative_route.max_weight_factor',  # noqa: E501
        'alternative_route_max_share_factor': 'alternative_route.max_share_factor',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            points ([[float]]): The points for the route in an array of `[longitude,latitude]`. For instance, if you want to calculate a route from point A to B to C then you specify `points: [ [A_longitude, A_latitude], [B_longitude, B_latitude], [C_longitude, C_latitude]] . [optional]  # noqa: E501
            ...
            curbsides ([str]): Optional parameter. It specifies on which side a point should be relative to the driver when she leaves/arrives at a start/target/via point. You need to specify this parameter for either none or all points. Only supported for motor vehicle profiles and OpenStreetMap.. [optional]  # noqa: E501
            locale (str): The locale of the resulting turn instructions. E.g. `pt_PT` for Portuguese or `de` for German. . [optional] if omitted the server will use the default value of "en"  # noqa: E501
            ...
            instructions (bool): If instructions should be calculated and returned . [optional] if omitted the server will use the default value of True  # noqa: E501
            calc_points (bool): If the points for the route should be calculated at all. . [optional] if omitted the server will use the default value of True  # noqa: E501
            debug (bool): If `true`, the output will be formatted. . [optional] if omitted the server will use the default value of False  # noqa: E501
            ...
            ch_disable (bool): Use this parameter in combination with one or more parameters from below. . [optional] if omitted the server will use the default value of False  # noqa: E501
            custom_model (CustomModel): [optional]  # noqa: E501
            headings ([int]): Favour a heading direction for a certain point. Specify either one heading for the start point or as many as there are points. In this case headings are associated by their order to the specific points. Headings are given as north based clockwise angle between 0 and 360 degree. This parameter also influences the tour generated with `algorithm=round_trip` and forces the initial direction.  Requires `ch.disable=true`. . [optional]  # noqa: E501
            heading_penalty (int): Time penalty in seconds for not obeying a specified heading. Requires `ch.disable=true`. . [optional] if omitted the server will use the default value of 120  # noqa: E501
            pass_through (bool): If `true`, u-turns are avoided at via-points with regard to the `heading_penalty`. Requires `ch.disable=true`. . [optional] if omitted the server will use the default value of False  # noqa: E501
            ...
            round_trip_distance (int): If `algorithm=round_trip`, this parameter configures approximative length of the resulting round trip. Requires `ch.disable=true`. . [optional] if omitted the server will use the default value of 10000  # noqa: E501
            round_trip_seed (int): If `algorithm=round_trip`, this sets the random seed. Change this to get a different tour for each value. . [optional]  # noqa: E501
            alternative_route_max_paths (int): If `algorithm=alternative_route`, this parameter sets the number of maximum paths which should be calculated. Increasing can lead to worse alternatives. . [optional] if omitted the server will use the default value of 2  # noqa: E501
            alternative_route_max_weight_factor (float): If `algorithm=alternative_route`, this parameter sets the factor by which the alternatives routes can be longer than the optimal route. Increasing can lead to worse alternatives. . [optional] if omitted the server will use the default value of 1.4  # noqa: E501
            alternative_route_max_share_factor (float): If `algorithm=alternative_route`, this parameter specifies how similar an alternative route can be to the optimal route. Increasing can lead to worse alternatives. . [optional] if omitted the server will use the default value of 0.6  # noqa: E501
        """

...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(op.f("shapes_organization_id_fkey"), 'shapes', type_='foreignkey')
    op.drop_column('shapes', 'organization_id')
    op.drop_constraint(op.f("organizations_created_by_user_id_fkey"), 'organizations', type_='foreignkey')

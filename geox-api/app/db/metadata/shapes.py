...
from sqlalchemy import (Column, Computed, DateTime, ForeignKey,  # type: ignore
                        Table, Integer, String)
from sqlalchemy.dialects.postgresql import JSONB, TSVECTOR, UUID
from geoalchemy2 import Geometry
from sqlalchemy import Column, DateTime, ForeignKey, Integer, String, Index, Table, Computed  # type: ignore

...
export class OrganizationsService {
     ...
     * @throws ApiError
     */
    public static getOrganizationsOrganizationsGet(): CancelablePromise<Array<Organization>> {
     ...
     * @throws ApiError
     */
    public static fetchActiveOrgOrganizationsActiveGet(): CancelablePromise<Organization> {
        return __request(OpenAPI, {
            method: 'GET',

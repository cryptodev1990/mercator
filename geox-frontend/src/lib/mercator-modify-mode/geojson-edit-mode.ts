...
import { EditMode } from "@nebula.gl/edit-modes/src/lib/edit-mode";
  ...
  getAddFeatureOrBooleanPolygonAction(
    ...
    if (modeConfig && modeConfig.booleanOperation) {
      ...
      if (modeConfig.booleanOperation === "union") {
        updatedGeometry = turfUnion(selectedFeature as any, feature);
      ...
      if (!updatedGeometry) {
        // eslint-disable-next-line no-console,no-undef
        console.warn(
          "Canceling edit. Boolean operation erased entire polygon."
        );
        return null;
      }
      ...
      const updatedData = new ImmutableFeatureCollection(props.data)
        .replaceGeometry(featureIndex, updatedGeometry.geometry as any)
        .getObject();

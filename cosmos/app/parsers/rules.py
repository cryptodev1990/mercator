"""Rule based query parser using SpaCy."""
import logging
...
def parse_default(span: Span) -> SpRelCoveredBy | NamedPlace | Place:
    ...
    if noun_chunk:
        ...
        return Place(value=[str(tok) for tok in span])

...
from app.schemas import AreaNearConstraintArgument

MAX_SIMULTANEOUS_ISOCHRONES = 100

def _prepare_args_for_area_near_constraint(collective_dict: Dict) -> List[AreaNearConstraintArgument]:
    ...
    for i in range(0, len(items), 2):
        records.append(AreaNearConstraintArgument(
...
async def x_within_time_or_distance_of_y(
    ...
    res0 = await area_near_constraint(
